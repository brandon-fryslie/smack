(function() {
  var CoffeeScript, SmackLexer, compile, fs, lexer, parser, path;

  if (typeof module !== "undefined" && module !== null) {
    CoffeeScript = require('coffee-script');
    fs = require('fs');
    path = require('path');
    SmackLexer = require('./SmackLexer').SmackLexer;
    parser = require('./SmackParser').parser;
  ...
  parser.lexer = {
    lex: function() {
      var tag, _ref;
      _ref = this.tokens[this.pos++] || [''], tag = _ref[0], this.yytext = _ref[1];
      return tag;
    },
  ...
  exports.build = function() {
    return fs.writeFile('SmackCompiler.js', parser.generate());
  };
