...
# Tokens valid in config section of smack tag
# NON_CONFIG_TOKENS = ['ELEMENT', '']
...
if module? and not module.parent?
  ...
  # console.log lex.tokenize('~| Upload Successful! ~>p#status.block-message |alt:Bla Bla Bla| > div.clear-fix |~')
  ...
  #
  # ok _.isEqual lex.tokenize('~| p~ Hi! |~'), [ [ 'OPENTAG', '~| ' ], [ 'ELEMENT', 'p' ], [ 'HTML_ID', null ], [ 'HTML_CLASSES', null ], [ 'HTML_ATTRIBUTES', null ], [ 'LITERAL', 'Hi!' ], [ 'CLOSETAG', ' |~' ] ]
  
  # ok _.isEqual lex.tokenize('~| Hi! ~p |~'), [ [ 'OPENTAG', '~| ' ], [ 'LITERAL', 'Hi!' ], [ 'ELEMENT', 'p' ], [ 'HTML_ID', null ], [ 'HTML_CLASSES', null ], [ 'HTML_ATTRIBUTES', null ], [ 'CLOSETAG', ' |~' ] ]
  
  # ok _.isEqual lex.tokenize('~| p#status.block-message~ Upload Successful! |~'), [ [ 'OPENTAG', '~| ' ], [ 'ELEMENT', 'p' ], [ 'HTML_ID', 'status' ], [ 'HTML_CLASSES', '.block-message' ], [ 'HTML_ATTRIBUTES', null ], [ 'LITERAL', 'Upload Successful!' ], [ 'CLOSETAG', ' |~' ] ]
  
  # ok _.isEqual lex.tokenize('~| Upload Successful!~ p#status.block-message |~'), [ [ 'OPENTAG', '~| ' ], [ 'ELEMENT', 'p' ], [ 'HTML_ID', 'status' ], [ 'HTML_CLASSES', '.block-message' ], [ 'HTML_ATTRIBUTES', null ], [ 'LITERAL', 'Upload Successful!' ], [ 'CLOSETAG', ' |~' ] ]
  
  # ok _.isEqual lex.tokenize('~| p#status.block-message |alt:Bla Bla Bla| > div.clear-fix~'), [ [ 'OPENTAG', '~| ' ], [ 'ELEMENT', 'p' ], [ 'HTML_ID', 'status' ], [ 'HTML_CLASSES', '.block-message' ], [ 'HTML_ATTRIBUTES', null ], [ 'LITERAL', 'Upload Successful!' ], [ 'CLOSETAG', ' |~' ] ]
